...
public class WebXiangqiServer {
    ...
    private static final class Session {
        ...
        return String.join("\n",
            ...
            "    body{margin:0;min-height:100vh;display:grid;place-items:center;background:radial-gradient(900px 280px at 50% -8%,rgba(255,235,179,.72),transparent 62%),linear-gradient(180deg,#9ec9e7 0%,#d39c63 52%,#8b5a35 100%);font-family:Microsoft YaHei UI,sans-serif;color:var(--ink);overflow:hidden;}",
            "    .wrap{width:min(1320px,98vw);height:calc(100vh - 24px);background:linear-gradient(180deg,rgba(255,248,236,.97),rgba(245,226,196,.96));border:1px solid #d9bd93;border-radius:14px;box-shadow:0 18px 38px rgba(69,47,22,.28);padding:12px;box-sizing:border-box;position:relative;}",
            "    .wrap:before{content:'';position:absolute;left:14px;right:14px;top:14px;height:110px;border-radius:12px;background:linear-gradient(180deg,rgba(120,64,28,.88),rgba(74,38,16,.86));opacity:.28;pointer-events:none;}",
            "    .wrap:after{content:'';position:absolute;left:24px;right:24px;bottom:18px;height:80px;border-radius:10px;background:linear-gradient(180deg,rgba(82,44,20,.30),rgba(82,44,20,.08));pointer-events:none;}",
