...
public class WebXiangqiServer {
    ...
    private static final class Session {
        ...
        return String.join("\n",
            ...
            "    body{margin:0;min-height:100vh;display:grid;place-items:center;background:linear-gradient(165deg,var(--bg2),var(--bg1));font-family:Microsoft YaHei UI,sans-serif;color:var(--ink);overflow:hidden;}",
            "    .wrap{width:min(1320px,98vw);height:calc(100vh - 24px);background:#fff7ec;border:1px solid #d9bd93;border-radius:14px;box-shadow:0 18px 38px rgba(69,47,22,.18);padding:12px;box-sizing:border-box;}",
